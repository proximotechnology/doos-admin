document.addEventListener('alpine:init', () => {
        ...
        async updateManager(managerId) {
            ...
            try {
                ...
                if (!token) {
                    ...
                    return;
                } const response = await fetch(`${this.apiBaseUrl}/api/admin/brand_car/update/${managerId[0]}`, {
                    method: 'PUT',
                    headers: {
                ...
                Swal.fire({
                    ...
                    text: Alpine.store('i18n').t('brand_updated_successfully'),
                    timer: 3000,
                ...
                Swal.fire({
                    ...
                    text: error.message || Alpine.store('i18n').t('failed_update_brand'),
                });
            } finally {
                loadingIndicator.hide();
            }
    ...
    coloredToast = (color, message) => {
        ...
        toast.fire({
            title: message, // Show the custom message
        });
    };
