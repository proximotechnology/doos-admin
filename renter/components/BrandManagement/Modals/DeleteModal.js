document.addEventListener('alpine:init', () => {
    Alpine.store('deleteModal', {
        ...
        async openModal(id, brandName, callback) {
            this.managerId = id;
            this.brandName = brandName || 'this brand';
                ...
                html: `
                    <div class="text-right">
                        <p class="mb-4 text-gray-700 dark:text-gray-300">
                            ${Alpine.store('i18n').t('confirm_delete_brand') || 'Are you sure you want to delete this brand?'}
                        </p>
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="font-semibold text-gray-900 dark:text-white">
                                        ${Alpine.store('i18n').t('brand') || 'Brand'}: <span class="text-primary">${this.brandName}</span>
                                    </p>
