document.addEventListener('DOMContentLoaded', async function () {
    ...
    if (loader) {
        ...
        await loader.loadStandardLayout({
            ...
            main: { path: 'components/SeasonalPricingManagement/SeasonalPricingManagement.html', container: 'seasonal-pricing-management-container', loadScript: false }
        });
        
        // Load modals
        await loader.load('components/SeasonalPricingManagement/Modals/UpdateModal.html', 'update-modal-container', { loadScript: false });
    }
});
