document.addEventListener('alpine:init', () => {
    Alpine.store('deleteModal', {
        ...
        async openModal(id, roleName, callback) {
            this.roleId = id;
            this.roleName = roleName || 'this role';
                ...
                html: `
                    <div class="text-right">
                        <p class="mb-4 text-gray-700 dark:text-gray-300">
                            ${Alpine.store('i18n').t('confirm_delete_role') || 'Are you sure you want to delete this role?'}
                        </p>
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="font-semibold text-gray-900 dark:text-white">
                                        ${Alpine.store('i18n').t('role_name') || 'Role'}: <span class="text-primary">${this.roleName}</span>
                                    </p>
