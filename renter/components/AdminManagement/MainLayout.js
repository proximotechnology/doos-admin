document.addEventListener('DOMContentLoaded', async function () {
    ...
    if (loader) {
        ...
        await loader.loadStandardLayout({
            ...
            main: { path: 'components/AdminManagement/AdminManagement.html', container: 'admin-management-container', loadScript: false }
        });

        // Load modals
        await loader.load('components/AdminManagement/Modals/EditModal.html', 'edit-modal-container', { loadScript: false });
        await loader.load('components/AdminManagement/Modals/DeleteModal.html', 'delete-modal-container', { loadScript: false });
    } else {
