...
(function() {
    function registerChatComponent() {
        ...
        async loadCurrentUser() {
            ...
            try {
                const data = await ApiService.getMyOnlineStatus();
        ...
        async markMessagesAsRead(userId) {
            ...
            try {
                ...
                if (unreadMessages.length > 0) {
                    ...
                    const result = await ApiService.markMessagesAsRead(userId, messageIds, this.selectedUser.conversationId);
        ...
        async updateLastSeen() {
            ...
            try {
                await ApiService.updateLastSeen();
            } catch (error) {
                }
        },
        ...
        async getConversation(userId, page = 1, perPage = 20) {
            ...
            try {
                const data = await ApiService.getConversation(userId, page, perPage);
