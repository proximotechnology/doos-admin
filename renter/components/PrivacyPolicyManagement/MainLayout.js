/**
 * Privacy Policy Management MainLayout
 * 
...
document.addEventListener('DOMContentLoaded', async function () {
    ...
    if (loader) {
        ...
        await loader.loadStandardLayout({
            ...
            main: { path: 'components/PrivacyPolicyManagement/PrivacyPolicyManagement.html', container: 'privacy-policy-management-container', loadScript: false }
        });
        ...
        await new Promise(resolve => setTimeout(resolve, 1000));
            ...
            try {
                ...
                // Load Update Modal
                const updateModalResponse = await fetch('components/PrivacyPolicyManagement/Modals/UpdateModal.html');
        ...
        loadComponentFallback('components/PrivacyPolicyManagement/PrivacyPolicyManagement.html', 'privacy-policy-management-container');
    }
});
