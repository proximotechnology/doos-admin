/**
 * Cookies Policy Management MainLayout
 * 
...
document.addEventListener('DOMContentLoaded', async function () {
    ...
    if (loader) {
        ...
        await loader.loadStandardLayout({
            ...
            main: { path: 'components/CookiesPolicyManagement/CookiesPolicyManagement.html', container: 'cookies-policy-management-container', loadScript: false }
        });
        ...
        await new Promise(resolve => setTimeout(resolve, 1000));
            ...
            try {
                ...
                // Load Update Modal
                const updateModalResponse = await fetch('components/CookiesPolicyManagement/Modals/UpdateModal.html');
        ...
        loadComponentFallback('components/CookiesPolicyManagement/CookiesPolicyManagement.html', 'cookies-policy-management-container');
    }
});
