    ...
    Alpine.data('Add_Car', () => ({
        ...
        async addCar() {
            try {
                ...
                await ApiService.storeCar(formData);

                coloredToast('success', Alpine.store('i18n').t('car_added_success') || 'Car added successfully');
                ...
                coloredToast('danger', error.message || Alpine.store('i18n').t('failed_to_add_car') || 'Failed to add car');
            } finally {
