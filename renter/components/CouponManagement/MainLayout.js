document.addEventListener('DOMContentLoaded', async function () {
    ...
    if (loader) {
        ...
        await loader.loadStandardLayout({
            ...
            main: { path: 'components/CouponManagement/coupon-management.html', container: 'coupon-management-container', loadScript: false }
        });
        
        // Load modals
        await loader.load('components/CouponManagement/Modals/UpdateModal.html', 'update-modal-container', { loadScript: false });
        await loader.load('components/CouponManagement/Modals/DeleteModal.html', 'delete-modal-container', { loadScript: false });
    } else {
