document.addEventListener('DOMContentLoaded', async function () {
    ...
    if (loader) {
        ...
        await loader.loadStandardLayout({
            ...
            main: { path: 'components/DiscountManagement/discount-management.html', container: 'discount-management-container', loadScript: false }
        });
        
        // Load modals
        await loader.load('components/DiscountManagement/Modals/UpdateModal.html', 'update-modal-container', { loadScript: false });
        await loader.load('components/DiscountManagement/Modals/DeleteModal.html', 'delete-modal-container', { loadScript: false });
    } else {
